    ...
    return Scaffold(body: SingleChildScrollView(
      child: Column(crossAxisAlignment: CrossAxisAlignment.center,
        ...
        children: [Padding(
          ...
          child:
          IconButton(
            icon: Icon(Icons.keyboard_backspace_sharp, size: 33, weight: 15.0,),
            onPressed: () {
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Padding(
                ...
                child: Text(
                    "Password", style: TextStyle(color: Color(0xff0A0A0A),
                    fontWeight: FontWeight.w700, fontSize: 20)),
              ),
              Padding(
                padding: const EdgeInsets.only(
              ...
              Padding(
                ...
                child: TextButton(onPressed: () {
                  Get.to(() => ForgetPassword());
                    ...
                    0xff666666), fontWeight: FontWeight.w900),)),
              ),
              Padding(
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.end,
                ...
                children: [Padding(
                  ...
                  child: Text(
                    "Don’t have an account?", style: TextStyle(color: Color(
                      0xff0A0A0A).withOpacity(0.8), fontWeight: FontWeight
                      .w500),),
                ),
                  TextButton(onPressed: () {
                    Get.to(() => SignUp());
                      ...
                      child: Text(
                        "Sign up fo free", style: TextStyle(color: Color(
                          0xff666666), fontWeight: FontWeight.w900),))
                ],)
            ],),),
        ],),
